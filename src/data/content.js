...
export const personal = {
  ...
  summary:
    "Embedded Firmware Engineer specializing in bare-metal and RTOS-based firmware development in Embedded C/C++ on ARM Cortex-M platforms, including STM32, ESP32, and Nordic nRF5. Experience spans low-level peripheral drivers (GPIO, I2C, SPI, UART), hardware abstraction layers, and LVGL-based embedded GUIs, with ownership of board bring-up, firmware debugging, and hardware validation using JTAG/SWD, GDB, logic analyzers, and oscilloscopes. Currently developing TWS earbuds firmware at MIVI on RTX5 RTOS with Bluetooth Classic and BLE (A2DP, HFP, SPP, GATT), with additional depth in Embedded Linux, Linux device drivers, and Yocto.",
};
...
export const skillGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      "SPI/RGB Displays",
      "Desktop Application Development (Qt, C++)",
    ],
  },
  {
    label: "Tools",
